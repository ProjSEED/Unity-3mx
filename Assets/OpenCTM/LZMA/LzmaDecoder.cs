...
namespace SevenZip.Compression.LZMA
{
    ...
    public class Decoder : ICoder, ISetDecoderProperties // ,System.IO.Stream
	{
		...
		class LiteralDecoder
		{
            ...
            //private static LiteralDecoder instance;
            //public static LiteralDecoder GetInstance()
            //{
            //    if (instance==null)
            //    {
            //        instance = new LiteralDecoder();
            //    }
			...
			public byte DecodeNormal(RangeCoder.Decoder rangeDecoder, uint pos, byte prevByte)
			{
                ...
                //return m_CoderList[(int)GetState(pos, prevByte)].DecodeNormal(rangeDecoder);
            }

			public byte DecodeWithMatchByte(RangeCoder.Decoder rangeDecoder, uint pos, byte prevByte, byte matchByte)
			{
                return m_Coders[GetState(pos, prevByte)].DecodeWithMatchByte(rangeDecoder, matchByte);
                //return m_CoderList[(int)GetState(pos, prevByte)].DecodeWithMatchByte(rangeDecoder, matchByte);
            }
		};
		...
		void SetLiteralProperties(int lp, int lc)
		{
            ...
            //LiteralDecoder.GetInstance().Create(lp,lc);
		}
